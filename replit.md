...
2.  **Primary - State**: Curated seed data (✅ **446 statutes, 50 states + DC** - Nov 2025) - Comprehensive nationwide coverage with manually verified statutes. Original 10 states (CA, TX, FL, NY, PA, IL, OH, GA, NC, MI) have 20 statutes each covering top FBI UCR charges. Remaining 41 states + DC have 6 statutes each covering: assault, theft, DUI, fraud, domestic violence, and sexual assault.
...
**Current Status (Nov 2025)**: **Full 50-state coverage achieved with expanded categories!** OpenLaws API provides jurisdiction metadata only - no actual statute text in current tier. **Working solution**: GovInfo API for federal statutes + **446 manually curated state statutes covering all 50 states + DC**:
- **10 original states** (CA, TX, FL, NY, PA, IL, OH, GA, NC, MI): 20 statutes each covering FBI UCR 2024 top charges
- **41 additional states + DC**: 6 statutes each covering: assault, theft, DUI, fraud, domestic violence, and sexual assault using Bluebook legal citation standards
- **Category breakdown**: fraud (67), theft (63), assault (62), DUI (51), domestic_violence (47), public_order (44), sexual_assault (41), property (30), drug_offenses (20), weapons (11), violent (10)
